...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // SQL query to find nearby users
    ...
    $sql = "
        ...
        FROM location 
        JOIN lawyer ON lawyer.login_id = location.login_id
    ...
    $type = 'advocate'; // Set the user type
    $stmt->bind_param('dddsd', $your_latitude, $your_longitude, $your_latitude, $type, $radius);
    $stmt->execute();
